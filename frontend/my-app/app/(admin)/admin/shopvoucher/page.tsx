...
import { GET_SHOP_VOUCHERS } from '@/graphql/queries';
...
const ShopVoucherPage = () => {
    ...
    const { data, loading, error, refetch } = useQuery<ShopVouchersResponse>(GET_SHOP_VOUCHERS, {
    ...
    const vouchers = useMemo(() => data?.shopVouchers.data || [], [data]);
    const totalPages = useMemo(() => data?.shopVouchers.totalPage || 0, [data]);
